...
from app.modules.agents.contracts_explanation.node import (
    category_node,
    extract_node,
    clarification_node,
    retriver_node,
...
def build_contracts_explanation_app():
    """构建并返回合同说明工作流的 LangGraph 应用，用于 LangServe/业务调用。"""
