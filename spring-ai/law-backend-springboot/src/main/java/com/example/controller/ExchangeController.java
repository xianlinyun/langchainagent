...
public class ExchangeController {
    ...
    public ExchangeController() {
        try {
            String endpoint = "http://langchainagent-app:8000/rag_search/stream";
    ...
    @PostMapping("/exchange_analysis_stream")
    ...
    private String llmEndpoint() {
        ...
        if (env == null || env.isEmpty()) {
            return "http://langchainagent-app:8000/rag_search/stream";
        }
        return env;
    }
}